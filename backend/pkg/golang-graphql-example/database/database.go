...
func NewDatabase(cfgManager config.Manager, logger log.Logger, metricsCl metrics.Client) DB {
	return &postresdb{logger: logger, cfgManager: cfgManager, metricsCl: metricsCl}
}
